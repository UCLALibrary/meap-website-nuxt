...
export const actions = {
  ...
  async nuxtGenerateInit({ dispatch }, { generatePayload }) {
    ...
    const headerQuery = dispatch('setHeaderData', data.header)
    const footerPrimaryQuery = dispatch('setFooterPrimaryData', data.footerPrimary)
    const footerSponsorQuery = dispatch('setFooterSponsoryData', data.footerSponsor)
    const footerSockQuery = dispatch('setFooterSockData', data.footerSock)
    const globalsQuery = dispatch('getGlobals', data.globals)
